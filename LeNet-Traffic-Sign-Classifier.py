...
# Visualize the German Traffic Signs Dataset using the pickled files by displaying the "histogram" of classes
...
def LeNet(x):    
    ...
    # SOLUTION: Layer 1: Convolutional. Input = 32x32x3. Input Depth is 3 (RGB). Output = 28x28x6.
